...
export default function SettingsDialog({
    ...
    const getScopedValue = (key: keyof Settings): boolean | undefined => {
        return settings.forScope(selectedScope).settings[key] as
            | boolean
            | undefined;
    };
    ...
    return (
        ...
        >
            ...
            <Text color={Colors.Gray}>
                Tab: Switch Section ↑/↓/j/k: Navigate Enter: Toggle/Select Esc: Exit
            </Text>
            {showRestartPrompt && (
                <Text color={Colors.AccentYellow}>
                    Some changes may require a restart to take effect. Press r to restart
                    now.
                </Text>
            )}
        </Box>
